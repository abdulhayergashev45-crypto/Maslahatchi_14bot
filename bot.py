...
2. 🎓 Asosiy yo'nalishlar (eng mashhur 4-5 ta)
3. 📊 2024-2025 yil kirish ballari (DTM):
   - Grant uchun minimal ball (taxminiy)
   - Kontrakt uchun minimal ball (taxminiy)
4. 💰 Yillik kontrakt narxi (taxminiy, so'mda)
...
UZBEK_UNIVERSITIES = [
    ...
    ("🌐 WIUT", "Westminster Xalqaro Universiteti Toshkentda"),
    ("🇰🇷 INHA", "Inha Universiteti Toshkentda"),
    ("🇮🇹 Turin Politexnika", "Turin Politexnika Universiteti Toshkentda"),
    ("💻 TATU", "Toshkent Axborot Texnologiyalari Universiteti"),
    ("🏥 TTA", "Toshkent Tibbiyot Akademiyasi"),
    ("📚 SamDU", "Samarqand Davlat Universiteti"),
    ("⚖️ TSUL", "Toshkent Davlat Yuridik Universiteti"),
    ("💰 TDIU", "Toshkent Davlat Iqtisodiyot Universiteti"),
    ("🎨 O'zDSMI", "O'zbekiston Davlat San'at va Madaniyat Instituti"),
    ("🤖 Boshqa universitet", "__custom__"),
]
...
async def uni_custom_cb(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await q.message.edit_text(
        "🔍 Qaysi universiteti qidirmoqchisiz?\n\n"
        "Nomini yozing (masalan: *Namangan muhandislik texnologiya instituti*):",
        parse_mode=ParseMode.MARKDOWN
    )
    return UNI_SEARCH
...
async def uni_search_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    menu_buttons = [
        ...
        "📋 Portfel yaratish", "❓ Yordam va AI maslahat", "📊 Hisobot"
    ]
